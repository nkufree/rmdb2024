...
class StaticCKPTLogRecord: public LogRecord {
public:
    StaticCKPTLogRecord() {
...
public:
    ...
    UpdateLogRecord(txn_id_t txn_id, RmRecord& before_value, RmRecord& update_value, Rid& rid, std::string table_name) 
        : UpdateLogRecord() {
        log_tid_ = txn_id;
